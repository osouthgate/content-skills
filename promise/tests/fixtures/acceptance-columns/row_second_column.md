...
| # | Row | Given | When | Then | Altitude |
|---|-----|-------|------|------|----------|
| AT-1 | R1 | Ana is in a channel | she mutes it | she gets no push or badge from it | perception |
| AT-2 | R1 | Ana has muted a channel | she unmutes it | notifications resume immediately | perception |
| AT-3 | R2 | Ana has muted a channel | Ben (unmuted) gets a message in it | Ben is still notified normally | perception |
