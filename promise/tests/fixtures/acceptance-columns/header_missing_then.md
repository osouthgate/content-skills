...
| # | Given | When | Notes |
|---|-------|------|-------|
| AT-1 | Ana is in a channel | she mutes it | n/a |
| AT-2 | Ana has muted a channel | she unmutes it | n/a |
| AT-3 | Ana has muted a channel | Ben (unmuted) gets a message in it | n/a |
