...
| # | Given | When | Notes | Altitude |
|---|-------|------|-------|----------|
| AT-1 | Ana is in a channel | she mutes it | n/a | perception |
| AT-2 | Ana has muted a channel | she unmutes it | n/a | perception |
| AT-3 | Ana has muted a channel | Ben (unmuted) gets a message in it | n/a | perception |
