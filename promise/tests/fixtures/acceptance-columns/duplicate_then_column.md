...
|---|-------|------|------|------|
| AT-1 | Ana is in a channel | she mutes it | she gets no push or badge from it | she gets no push or badge from it |
| AT-2 | Ana has muted a channel | she unmutes it | notifications resume immediately | notifications resume immediately |
| AT-3 | Ana has muted a channel | Ben (unmuted) gets a message in it | Ben is still notified normally | Ben is still notified normally |
