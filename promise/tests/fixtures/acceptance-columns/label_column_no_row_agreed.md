...
| # | Label | Given | When | Then | Altitude |
|---|-------|-------|------|------|----------|
| AT-1 | routine | Ana is in a channel | she mutes it | she gets no push or badge from it | perception |
| AT-2 | routine | Ana has muted a channel | she unmutes it | notifications resume immediately | perception |
| AT-3 | routine | Ana has muted a channel | Ben (unmuted) gets a message in it | Ben is still notified normally | perception |
