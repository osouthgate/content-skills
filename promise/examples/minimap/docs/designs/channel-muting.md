...
|------|-------|------|------|----------|-----|
| AT-1 | Ana is in a channel | she mutes it | she gets no push or badge from it | perception | CAP-1 |
| AT-2 | Ana has muted a channel | she unmutes it | notifications resume immediately | perception | CAP-1 |
| AT-3 | Ana has muted a channel | Ben (unmuted) gets a message in it | Ben is still notified normally | perception | CAP-2 |

Snapshot taken at `agreed` on 2026-01-01; the map is the source of these scenarios from here on.
